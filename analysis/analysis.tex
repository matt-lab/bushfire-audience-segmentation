...
internal consistency of Fire Realities, we separated the factor into its
...
regression models predicting Climate Processes, the two Fire Realities
...
\(R^2_{adjusted}\) = 0.30), the two Fire Realities items (`Climate
...
Realities item of `Climate change made bushfires less likely',
...
\(p_{adjusted}\) = .182). For the second Fire Realities item of
...
Item & \parbox{5em}{\centering Climate Processes} & \parbox{5em}{\centering Fire Realities} & \parbox{5em}{\centering Arson Causes} & \textit{M} & \textit{SD}\\
\midrule
