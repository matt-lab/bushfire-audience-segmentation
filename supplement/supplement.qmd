---
title: "Supplementary materials for: \"Does extreme climate event exposure influence climate-related opinions? The case of the 2019–2020 Australian Black Summer bushfires?\""
description: Supplementary materials for the manuscript \"Does extreme climate event exposure influence climate-related opinions? The case of the 2019–2020 Australian Black Summer bushfires?\"
...
A log likelihood ratio test did not indicate an improvement in model fit when study was included as a predictor, compared to a model with only an intercept term ($\chi^{2}$ (`r lr_test_gender_diff$df`) = `r specify_decimal(lr_test_gender_diff$lr_stat)`, $p$ = `r specify_decimal(lr_test_gender_diff$pr_chi)`, $\omega =$ `r specify_decimal(lr_test_gender_diff$w)`).
...
tab_segment_change_footnotes <-
    c(
        ...
        "\\\\parbox{36em}{Each study was entered as a categorical predictor, with Study 2 as the reference category. Fencesitter was entered as the reference category of segment. Model estimates of coefficients were exponentiated to odds ratios.}"
    )
...
#    kable_styling(full_width = TRUE) |>
    add_header_above(
        c(
            " " = 2,
            r"{\\parbox{10em}{\\centering Ratio of Acceptors odds and Fencesitters odds}}" = 2,
            r"{\\parbox{10em}{\\centering Ratio of Sceptics odds and Fencesitters odds}}" = 2
        ),
        escape = FALSE
    ) |>
    column_spec(1:2, width = "6em") |>
