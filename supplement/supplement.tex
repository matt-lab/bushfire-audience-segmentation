...
\hypertarget{gender-differences-across-studies}{%
\subsection{Gender differences across
studies}\label{gender-differences-across-studies}}

\hypertarget{tbl-gender-diff}{}
\begin{table}
\caption{\label{tbl-gender-diff}Estimated effects of study on participant gender, estimated using a
multinomial logistic regression model. }\tabularnewline
...
\hypertarget{age-differences-across-studies}{%
\subsection{Age differences across
studies}\label{age-differences-across-studies}}

\hypertarget{tbl-age-diff}{}
\begin{table}
\caption{\label{tbl-age-diff}Linear regression models predicting participant age (years) as a
function of study. }\tabularnewline
...
\hypertarget{counterbalancing-of-auxiliary-psychological-scales}{%
...
\begin{table}
\caption{\label{tbl-segment-change}Estimated effects of study on segment membership, estimated using a
multinomial logistic regression model. }\tabularnewline
...
\begin{table}
\caption{\label{tbl-mean_diff}Difference in means of auxiliary psychological characteristics between
Study 1 and Study 3. }\tabularnewline
